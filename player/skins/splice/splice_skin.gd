class_name SpliceSkin
extends CharacterSkin

## Splice — Mixamo Ch20_nonPBR (65 bones, mixamorig6_* prefix). 16-clip set
...
const _FOOT_L_BONE := &"mixamorig6_LeftFoot"
const _FOOT_R_BONE := &"mixamorig6_RightFoot"
