...
Pairs with `docs/level_one_arc.md` (the rescue prank that establishes the
crew + walkie) and `docs/rules_for_dialogue.md` (the menu / probe pattern
...
`dialogue/dial_tone.dialogue` follows `docs/rules_for_dialogue.md`
...
Walkie lines are short, one-way (per `docs/rules_for_dialogue.md`
